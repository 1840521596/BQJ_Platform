...
class DciApplicationPage(Page):
    ...
    select_available_today_loc = (By.XPATH, '/html/body/div[2]/div[1]/div/div[2]/table[1]/tbody/tr[6]/td[3]')
    time_loc2 = (By.CSS_SELECTOR, '#app > div.infoCheck > div.infoCenter > div:nth-child(7) > form > div:nth-child(3) > div > div > input')
    select_available_today_loc2 = (By.XPATH, '/html/body/div[3]/div[1]/div/div[2]/table[1]/tbody/tr[6]/td[3]')
